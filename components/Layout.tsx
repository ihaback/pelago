...
const Layout = ({ children = null }: React.PropsWithChildren<{}>) => {
  const { showModal, closeModal, openModal } = useAuthModalContext();
  ...
  return (
    <>
      <Head>
        <title>ArchiPelago | Vacation cottages</title>
        <meta name="title" content="ArchiPelago | Vacation cottages" />
              ...
              <Link href="/">
                <a className="flex items-center space-x-1">
                  ...
                  <span className="text-xl font-semibold tracking-wider">
                    Archi<span className="text-primary-600">Pelago</span>
                  </span>
                </a>
              </Link>
              <div className="flex items-center space-x-4">
                ...
                {isLoadingUser ? (
                  ...
                  <button
                    type="button"
                    onClick={openModal}
                    className="ml-4 px-4 py-1 rounded-md bg-primary-600 hover:bg-primary-500 focus:outline-none focus:ring-4 focus:ring-primary-500 focus:ring-opacity-50 text-white transition"
                  >
                    Log in
                  </button>
                )}
